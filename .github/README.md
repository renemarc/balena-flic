...
- [`./Dockerfile-debian.Dockerfile`](../Dockerfile-debian.Dockerfile): A Debian-based version, meant to support the [x86_64 architecture](https://en.wikipedia.org/wiki/X86-64), as well as [i386](https://en.wikipedia.org/wiki/i386) through the same **post_checkout** Docker hook.
