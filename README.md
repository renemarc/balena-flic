...
[Architecture-specific](https://hub.docker.com/r/renemarc/balena-flic/tags/)  tags are automated builds, with their base images swapped at build-time using a [post_checkout](https://github.com/renemarc/balena-flic/blob/master/hooks/post_checkout) Docker hook.


### Automated build pipeline 🏗

![build pipeline](https://github.com/renemarc/balena-flic/raw/master/.github/build-pipeline.svg?sanitize=true)
